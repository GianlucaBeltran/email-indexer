...
<template>
  <label class="relative block md:w-1/3 w-full">
    ...
    <input
      ...
      placeholder="Search mail" type="text" name="search" v-model="search" />
    <button class="absolute inset-y-1 right-0 flex items-center" v-if="search" @click="deleteSearch">
      <svg xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 -960 960 960" width="25">
        <path
